...
val md_theme_light_primary = Color(0xFF00FA9A)app/src/main/java/com/google/samples/apps/sunflower/ui/Color.kt
...
val md_theme_light_secondaryContainer = Color(0xFF90EE90)
val md_theme_light_onSecondaryContainer = Color(0xFFFFFAFA)
